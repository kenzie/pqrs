...
denominator_validation :age do |encounter|
  (18..75).cover? encounter.patient_age
end

denominator_validation :ffs do |encounter|
  encounter.patient_is_fee_for_service == true
end
